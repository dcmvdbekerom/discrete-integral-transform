...
fig, [ax0, ax1] = plot_diff(spectra_default[broadening_max_widths[0]], spectra_DLM_opt, 'abscoeff',
                            figsize=(10,6))
ax0.set_ylim((0, 0.9))
...
axins.plot(*spectra_default[broadening_max_widths[0]].get('abscoeff', wunit='cm-1'), color='k', lw=2)
...
axins2.plot(*spectra_default[broadening_max_widths[0]].get('abscoeff', wunit='cm-1'), color='k', lw=2)
